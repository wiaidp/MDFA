...
# Linear with slope eta
      eta_vec<-c(rep(1,omega_Gamma),1+(eta/10)*(1:(K-omega_Gamma+1)))
    } else
    {
      if (c_eta)
      {
...
# Here we want a real spectrum for the target  (the real part is used to avoid complex numbers with zero imaginary parts)
